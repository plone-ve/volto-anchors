pipeline {
  ...
  environment {
        ...
        NAMESPACE = "@eeacms"
        SONARQUBE_TAGS = "volto.eea.europa.eu,demo-www.eea.europa.eu,prod-www.eea.europa.eu,biodiversity.europa.eu,www.eea.europa.eu-ims,demo-kitkat.dev2aws.eea.europa.eu,clmsdemo.devel6cph.eea.europa.eu,climate-advisory-board.europa.eu,forest.eea.europa.eu,climate-adapt.eea.europa.eu,www.eea.europa.eu-en"
        DEPENDENCIES = ""
        VOLTO = "alpha"
    }
